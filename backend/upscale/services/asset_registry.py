...
KNOWN_ASSETS: tuple[AssetMetadata, ...] = (
    ...
    _entry("BONK", "Bonk", "solana", "bonk", "mid", date(2022, 12, 25), tags=MEME,
           address="DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263", kraken=False, dex=True),
    _entry("WIF", "dogwifhat", "solana", "dogwifcoin", "mid", date(2023, 11, 20), tags=MEME,
           address="EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm", kraken=False, dex=True),
